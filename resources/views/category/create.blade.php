...
@section('content')
    ...
    @endif
    <div class="row">
        <h4 class="col-md-4">Add new Cetgory :</h4>
        <form class="col-md" action="/category" method="post">
            <div class="form-group row">
                <label class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-form-label col-form-right">Name :</label>
